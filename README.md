<div style="display:flex;gap:1%;margin-bottom:20px">
  <h1 style="border:none">Open SmartCity Test Case Extension Module of the Open SmartCity App</h1>
...
* copy `Development.xcconfig` and `Production.xcconfig` to `WORKSPACEROOT/SupportingFiles`, these files have to be ignored by git
#### enable `XCTestCase` search paths in your project #####
* set `ENABLE_TESTING_SEARCH_PATHS` to `YES` 
[see](https://forums.swift.org/t/the-error-cannot-find-auto-link-library-xctest-and-xctestswiftsupport/34785/3)
## Other
